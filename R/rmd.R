#' Uploads, updates, and downloads raw rmarkdown for collaborative editing on Google Docs
#'
#' `upload_rmd` allows upload of an .Rmd file as to Google Docs as a plain text document
#' `update_rmd` updates the content of an existing Google Docs file with the name gfile
#' `download_rmd` downloads a Google Docs file and changes the file extension to .Rmd
#'
